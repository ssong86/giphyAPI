...
function displayGifs(){
    ...
    var action = $(this).data("data-name");
    var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=1ZJH8kOA2RGcK21tB4rw7JkDrSfHcR1N&q="+ action+ "&limit=10&offset=0&rating=G&lang=en";
